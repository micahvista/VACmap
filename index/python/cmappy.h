...
static inline void align(const char *tseq, const char *qseq, int sc_mch, int sc_mis, int gapo, int gape)
{
...
static inline void mappy_revcomp(const uint8_t *target, const uint8_t *query, int cigarcode[], int *zdropped, int *max_q, int *max_t, int match, int mismatch, int gap_open_1, int gap_extend_1, int gap_open_2, int gap_extend_2, int bw, int zdropvalue, int *delcount, int *inscount)
{
	int i, a = match, b = mismatch; // a>0 and b<0
